...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=2.0),
        loss_mask=dict(type='DiceLoss', loss_weight=3.0),
        # training and testing settings
        train_cfg=dict(
            assigner=dict(
                type='MaskHungarianAssigner',
                cls_cost=dict(type='FocalLossCost', weight=2.0),
                mask_cost=dict(type='MaskIoUCost', weight=3.0))),
...
# learning policy
lr_config = dict(policy='step', step=[27, 33, 35, 36, 37])
