...
class SamplingMaskResult(util_mixins.NiceRepr):
    """Mask sampling r
    """
    ...
    def __init__(self, pos_inds, neg_inds, masks, gt_masks, assign_result,
        ...
        if gt_masks.numel() == 0:
            ...
            if len(gt_masks.shape) < 3:
                gt_masks = gt_masks.view(-1, gt_masks.shape[-2], gt_masks.shape[-1])
    ...
    def masks(self):
        ...
        return torch.cat([self.pos_masks, self.neg_masks], 0)
